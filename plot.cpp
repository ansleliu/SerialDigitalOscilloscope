    ...
    d_timerId( -1 )
{
    ...
    setAxisScale( QwtPlot::yLeft, 0.0, 3.5 );
    ...
    d_origin->setValue( d_interval.minValue() + d_interval.width() / 2.0, 3.5/2.0 );
    ...
    QPen curvePen;
    curvePen.setWidth(2);
    QColor curve = Qt::yellow;
    curve.setAlpha(150);
    curvePen.setColor(curve);
    d_curve->setPen(curvePen);
//    d_curve->setPen( canvas()->palette().color( QPalette::Dark ) );
